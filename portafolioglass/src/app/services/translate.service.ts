...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'hero.subtitle': 'Infrastructure · Technical Support · Network Engineering · Cybersecurity',
    ...
    'hero.tag1': '⚡ IT Infrastructure & Security Intern',
    'hero.tag2': 'Open to Work',
    // About
    'about.title': 'Sobre mí',
    'about.description': 'Escribe aquí un resumen sobre tu perfil profesional, tu pasión por el desarrollo de software, tus objetivos y los proyectos en los que te encanta colaborar.',
    // Skills
    ...
    'contact.emailValue': 'tuemail@ejemplo.com',
